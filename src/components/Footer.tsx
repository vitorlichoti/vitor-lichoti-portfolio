...
export default function Footer() {
  return (
    ...
    >
      <hr className="border-yellow-100 border-opacity-25" style={{width: 'auto'}} />
      <div style={{display: 'flex', flexWrap: 'wrap', height: '40px', alignItems: 'center', padding: '40px', gap: 20}}>
